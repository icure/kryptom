...
enum class BCryptAlgorithm(
    ...
    BCRYPT_CAPI_KDF_ALGORITHM("CAPI_KDF"), // The original documentation marks this as a wide string
    ...
    BCRYPT_SP800108_CTR_HMAC_ALGORITHM("SP800_108_CTR_HMAC"), // The original documentation marks this as a wide string
    BCRYPT_SP80056A_CONCAT_ALGORITHM("SP800_56A_CONCAT"), // The original documentation marks this as a wide string
    BCRYPT_PBKDF2_ALGORITHM("PBKDF2"), // The original documentation marks this as a wide string
